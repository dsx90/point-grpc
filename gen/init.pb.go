...
func (x *InitRequest) GetSec() string {
	if x != nil {
		return x.Sec
	}
	return ""
...
type InitResponse struct {
	...
	Id uint64 `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"` // ID постамата
}
...
func (x *InitResponse) GetId() uint64 {
	if x != nil {
		return x.Id
	}
	return 0
...
var file_init_proto_rawDesc = []byte{
	...
	0x69, 0x74, 0x22, 0x1f, 0x0a, 0x0b, 0x49, 0x6e, 0x69, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x12, 0x10, 0x0a, 0x03, 0x73, 0x65, 0x63, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03,
	0x73, 0x65, 0x63, 0x22, 0x1e, 0x0a, 0x0c, 0x49, 0x6e, 0x69, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52,
	0x02, 0x69, 0x64, 0x32, 0x3c, 0x0a, 0x0b, 0x49, 0x6e, 0x69, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x12, 0x2d, 0x0a, 0x04, 0x49, 0x6e, 0x69, 0x74, 0x12, 0x11, 0x2e, 0x69, 0x6e, 0x69,
	...
	0x65, 0x42, 0x1d, 0x5a, 0x1b, 0x61, 0x74, 0x6d, 0x5f, 0x70, 0x6f, 0x73, 0x74, 0x61, 0x6d, 0x61,
	0x74, 0x2e, 0x69, 0x6e, 0x69, 0x74, 0x2e, 0x76, 0x31, 0x3b, 0x69, 0x6e, 0x69, 0x74, 0x76, 0x31,
...
var file_init_proto_depIdxs = []int32{
	0, // 0: init.InitService.Init:input_type -> init.InitRequest
	1, // 1: init.InitService.Init:output_type -> init.InitResponse
